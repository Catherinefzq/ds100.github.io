...
### The following plots demonstrate our findings. Please feel free to check out corresponding dashboards.
<br/><br/>
...
```{r BRFSS_IM_year_race, echo=FALSE}
BRFSS_race_plot =
data_BRFSS_JZ %>% 
...
```{r BRFSS_IM_year_gender, echo=FALSE}
BRFSS_gender_plot = 
data_BRFSS_JZ %>% 
  filter(., gender != 'NA') %>% 
...
```{r BRFSS_IM_year_age, echo=FALSE}
BRFSS_age_plot = 
data_BRFSS_JZ %>%
